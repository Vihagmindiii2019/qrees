...
class Comments_model extends CI_Model{
	...
	var $column_order = array('c.commentId','t1.title','t2.userName','t2.email','c.commentMsg'); //set column field database for datatable orderable
	var $column_search = array('t1.title','t2.userName','t2.email'); //set column field database for datatable searchable
	var $order = array('c.commentId'=>'DESC'); // default order
	var $where = array();
	...
	function prepare_query(){
		...
		$this->db->join(USER_POST.' as t1','t1.postId = c.postId');
		$this->db->join(USER.' as t2','t2.userId = c.userId');
