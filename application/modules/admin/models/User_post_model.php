...
class User_post_model extends CI_Model{
    ...
    var $column_order = array('t1.postId','t1.title','t1.mediaType'); //set column field database for datatable orderable
    var $column_search = array('t1.title'); //set column field database for datatable searchable
    ...
    function prepare_query(){
        ...
        $userId = decoding($this->input->post('id'));
        $this->db->select('*');
