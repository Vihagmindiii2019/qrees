...
<head>
    ...
    <title>Qrees | Password Reset</title>
...
<body style="font-family: 'Source Sans Pro', sans-serif; padding:0; margin:0;">
    <table style="max-width: 750px; margin: 0px auto; width: 100% ! important; background: #F3F3F3; padding:30px 30px 30px 30px;" width="100% !important" border="0" cellpadding="0" cellspacing="0">
        <tr>
            <td style="text-align: center; background: #e2a43bed;">
                <table width="100%" border="0" cellpadding="30" cellspacing="0">	
                    <tr>
                        <td>
                            <img style="padding: 10px;" height="40" width="40" src="<?php echo base_url().USER_DEFAULT_AVATAR; ?>">
                        </td>
                    </tr>
                </table>
            </td>
                ...
                <table width="100%" border="0" cellpadding="30" cellspacing="0" bgcolor="#fff">
                    <tr>
                        <td>
                            ...
                            <p style="text-align: left;color: #333; font-size: 16px; line-height: 28px;">You Recently requested to reset your password for your Qrees account. Please use password given below to login: </p>
                            ...
                            <p style="text-align: left;color: #333; font-size: 16px; line-height: 28px;">Thanks,<br>Team Lasross</p>  
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            <td style="text-align: center;">
                <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#fff">
                    <tr>
                        <td style="padding: 10px;background: #e2a43bed;color: #fff;"><?php echo COPYRIGHT; ?></td>
                    </tr>
                </table>
            </td>
        </tr>
